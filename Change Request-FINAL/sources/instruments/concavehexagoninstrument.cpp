#include "concavehexagoninstrument.h"
#include "../imagearea.h"
...
ConcaveHexagonInstrument::ConcaveHexagonInstrument(QObject *parent) :
	AbstractInstrument(parent)
{

}
void ConcaveHexagonInstrument::mousePressEvent(QMouseEvent *event, ImageArea &imageArea)
{
...
void ConcaveHexagonInstrument::mouseMoveEvent(QMouseEvent *event, ImageArea &imageArea)
{
...
void ConcaveHexagonInstrument::mouseReleaseEvent(QMouseEvent *event, ImageArea &imageArea)
{
	if (imageArea.isPaint())
	{
		imageArea.setImage(mImageCopy);
...
void ConcaveHexagonInstrument::paint(ImageArea &imageArea, bool isSecondaryColor, bool additionalFlag)
{
	...
	if (mStartPoint != mEndPoint)
	{
		...
		//functionality for Concave Hexagon
		QPolygon poly;
		...
		//Need set of 5 because hexagon can be positive/negative on both X/Y-axis
		if (xSize > 0 && ySize > 0)
		{
